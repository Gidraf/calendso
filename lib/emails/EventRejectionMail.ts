...
<body style="background: #f4f5f7; font-family: Helvetica, sans-serif">
  ...
  <div style="text-align: center; margin-top: 20px; color: #ccc; font-size: 12px;">
    <img style="opacity: 0.25; width: 120px;" src="https://res.cloudinary.com/g-draf-inc/image/upload/v1590265880/logo_mduxbk.png" alt="Glab Tech Services Logo Logo"></div>
</body>
  `
    );
  }
