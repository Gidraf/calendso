              ...
              <div
                ...
                <div>
                  {props.payment.success && !props.payment.refunded && (
                    <div className="mt-4 text-center text-gray-700 dark:text-gray-300">Paid</div>
                  )}
                  ...
                  {props.payment.refunded && (
                    <div className="mt-4 text-center text-gray-700 dark:text-gray-300">Refunded</div>
                  )}
                </div>
                {!props.profile.hideBranding && (
                  <div className="pt-4 mt-4 text-xs text-center text-gray-400 border-t dark:border-gray-900 dark:text-white">
                    <a href="#">Created and Designed By Glab Tech Services</a>
                  </div>
                )}
              </div>
            </div>
